    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($user->role) ?></td>
                <td><?= $user->has('category') ? $this->Html->link($user->category->name, ['controller' => 'Category', 'action' => 'view', $user->category->id]) : '' ?></td>
                <td><?= h($user->status) ?></td>
                <td><?= $this->Number->format($user->subcategory_id) ?></td>
